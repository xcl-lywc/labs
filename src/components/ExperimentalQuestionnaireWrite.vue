...
<script> 
  export default {
    ...
    watch:{
      questionnaireData(newVal,oldVal){
        if(newVal){
    ...
    methods: {  
      ...
      getQueryAnswerMember(){
        this.axios.get(`${this.common.basePath}/qanswer/member/${this.questionnaireData.id}`,'').then((response) => { 
       ...
       */
      getQueryPaperDetail(){
        this.axios.get(`${this.common.basePath}/questionnaire/${this.questionnaireData.questionnaireId}`,'').then((response) => { 
      ...
      getQueryQuestionnaireList(){ 
        this.axios.get(`${this.common.basePath}/qitem`,{params: {questionnaire_id: this.questionnaireData.questionnaireId, sheet_id: this.sheet_id}}).then((response) => {  
      ...
      submit(){
        this.axios.post(`${this.common.basePath}/qanswer/answer/${this.questionnaireData.questionnaireId}/${this.participantId}/${this.questionnaireData.id}`,this._convertAnswer()).then((response) => {
          this.getQueryAnswerMember(); 
